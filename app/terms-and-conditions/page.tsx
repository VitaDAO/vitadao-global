    ...
    <div className="mx-auto max-w-[1260px] @container">
      <div className="px-[20px] py-[30px] @xl:px-[30px] @xl:pt-[90px]">
        ...
        <p className="mb-[30px] max-w-[770px] text-base">
          ...
          nulla ut consequat qui est adipisicing eu officia. Incididunt
          cupidatat labore sunt deserunt Lorem sunt reprehenderit dolor eiusmod
          qui esse fugiat. Do sit mollit voluptate occaecat cillum.
        </p>
      </div>
    </div>
  );
