export default function Page() {
  return (
    <div className="mx-auto max-w-[1260px] @container">
      <div className="px-[20px] py-[30px] @xl:px-[30px] @xl:pt-[90px] [&>h2]:mt-9 [&>h2]:text-lg [&>h2]:font-medium [&>p]:mt-5 [&_a]:text-vita-purple [&_a]:underline [&_a]:underline-offset-4 [&_ul>li>*]:mt-3 [&_ul>li>p:first-of-type]:font-medium [&_ul>li]:mt-3 [&_ul]:ml-5 [&_ul_ul_li]:list-disc">
        <h1 className="mb-[10px] text-h2 font-medium">Privacy policy</h1>
        <p>
          We are very delighted that you have shown interest in our enterprise.
          Data protection is of a particularly high priority for the management
          of VitaDAO. The use of the Internet pages of VitaDAO is possible
        ...
        <p>
          ...
          VitaDAO. By means of this data protection declaration, our enterprise
        ...
        <p>
          As the controller, VitaDAO has implemented numerous technical and
        ...
        <h2>1. Definitions</h2>
        <p>
          The data protection declaration of VitaDAO is based on the terms used
        ...
        <p>VitaDAO</p>
        <p>Email: dao@vitadao.com</p>
        <p>Website: vitadao.com</p>
        <h2>3. Cookies</h2>
        <p>
          The Internet pages of VitaDAO use cookies. Cookies are text files that
        ...
        <p>
          Through the use of cookies, VitaDAO can provide the users of this
        ...
        <p>
          The website of VitaDAO collects a series of general data and
        ...
        <p>
          When using these general data and information, VitaDAO does not draw
          ...
          cyber-attack. Therefore, VitaDAO analyzes anonymously collected data
        ...
        <p>
          ...
          controller with the indication of personal data. Which personal data
          are transmitted to the controller is determined by the respective
          ...
          uses personal data for an internal purpose which is attributable to
          the controller.
        </p>
        <p>
        ...
        <p>
          On the website of VitaDAO, users are given the opportunity to
        ...
        <p>
          VitaDAO informs its customers and business partners regularly by means
          of a newsletter about enterprise offers. The enterprise&apos;s
        ...
        <p>
          ...
          to our newsletter may be terminated by the data subject at any time.
          The consent to the storage of personal data, which the data subject
          has given for shipping the newsletter, may be revoked at any time. For
          the purpose of revocation of consent, a corresponding link is found in
          each newsletter. It is also possible to unsubscribe from the
          newsletter at any time directly on the website of the controller, or
          to communicate this to the controller in a different way.
        </p>
        <h2>7. Newsletter-Tracking</h2>
        <p>
          The newsletter of VitaDAO contains so-called tracking pixels. A
          tracking pixel is a miniature graphic embedded in such e-mails, which
          are sent in HTML format to enable log file recording and analysis.
          This allows a statistical analysis of the success or failure of online
          marketing campaigns. Based on the embedded tracking pixel, VitaDAO may
          see if and when an e-mail was opened by a data subject, and which
        ...
        <p>
          ...
          subject. These personal data will not be passed on to third parties.
          Data subjects are at any time entitled to revoke the respective
          ...
          the controller. VitaDAO automatically regards a withdrawal from the
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              ...
              wishes to request the erasure of personal data stored by VitaDAO,
              he or she may, at any time, contact any employee of the
              controller. An employee of VitaDAO shall promptly ensure that the
            ...
            <p>
              ...
              far as processing is not required. An employees of VitaDAO will
          ...
          <li>
            ...
            <p>
              ...
              data stored by VitaDAO, he or she may at any time contact any
              employee of the controller. The employee of VitaDAO will arrange
          ...
          <li>
            ...
            <p>
              ...
              may at any time contact any employee of VitaDAO.
            </p>
          </li>
          <li>
            ...
            <p>
              VitaDAO shall no longer process the personal data in the event of
            ...
            <p>
              If VitaDAO processes personal data for direct marketing purposes,
              ...
              VitaDAO to the processing for direct marketing purposes, VitaDAO
            ...
            <p>
              ...
              personal data concerning him or her by VitaDAO for scientific or
            ...
            <p>
              ...
              contact any employee of VitaDAO In addition, the data subject is
          ...
          <li>
            ...
            <p>
              ...
              consent, VitaDAO shall implement suitable measures to safeguard
            ...
            <p>
              ...
              contact any employee of VitaDAO.
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          application &quot;_gat. _anonymizeIp&quot;. By means of this
        ...
        <p>
          ...
          the data subject must download a browser add-on under{" "}
          ...
          the browser add-ons to disable Google Analytics. If the browser add-on
        ...
        <p>
          ...
          . Google Analytics is further explained under{" "}
        ...
        <p>
          ...
          Twitter is a multilingual, publicly-accessible microblogging service
          on which users may publish and spread so-called &apos;tweets&apos;,
        ...
        <p>
          ...
          data subject. The purpose of the integration of the Twitter component
          is a retransmission of the contents of this website to allow our users
        ...
        <p>
          ...
          website, then Twitter assigns this information to the personal Twitter
        ...
        <p>
          ...
          under{" "}
          <a href="https://twitter.com/privacy?lang=en">
        ...
        <p>
          ...
          . During the course of this technical procedure, YouTube and Google
          gain knowledge of what specific sub-page of our website was visited by
          the data subject.
        </p>
        <p>
        ...
        <h2>13. Legal basis for the processing</h2>
        <p>
        ...
        <h2>15. Period for which the personal data will be stored</h2>
        <p>
        ...
        <h2>17. Existence of automated decision-making</h2>
        <p>
        ...
        <p>
          ...
          <a href="https://www.wbs-law.de/eng/">Lawyers</a> from WILDE BEUGER
          SOLMECKE, Cologne.
        </p>
      </div>
    </div>
