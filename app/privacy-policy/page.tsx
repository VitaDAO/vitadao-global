  ...
  return (
    <div className="px-[20px] py-[30px] @xl/main:px-[30px] @xl/main:pt-[90px] [&>h2]:mt-9 [&>h2]:text-lg [&>h2]:font-medium [&>p]:mt-5 [&_a]:text-vita-purple [&_a]:underline [&_a]:underline-offset-4 [&_ul>li>*]:mt-3 [&_ul>li>p:first-of-type]:font-medium [&_ul>li]:mt-3 [&_ul]:ml-5 [&_ul_ul_li]:list-disc">
      ...
      <p>
        ...
        VitaDAO. The use of the Internet pages of VitaDAO is possible without
      ...
      <h2>1. Definitions</h2>
      <p>
        The data protection declaration of VitaDAO is based on the terms used by
      ...
      <p>
        ...
        shop. The online store remembers the articles that a customer has placed
      ...
      <p>
        The website of VitaDAO collects a series of general data and information
      ...
      <p>
        When using these general data and information, VitaDAO does not draw any
        ...
        cyber-attack. Therefore, VitaDAO analyzes anonymously collected data and
      ...
      <p>
        On the website of VitaDAO, users are given the opportunity to subscribe
        to our enterprise&apos;s newsletter. The input mask used for this
      ...
      <p>
        The newsletter of VitaDAO contains so-called tracking pixels. A tracking
        pixel is a miniature graphic embedded in such e-mails, which are sent in
        HTML format to enable log file recording and analysis. This allows a
        statistical analysis of the success or failure of online marketing
        campaigns. Based on the embedded tracking pixel, VitaDAO may see if and
      ...
      <p>
        ...
        controller. VitaDAO automatically regards a withdrawal from the receipt
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            wishes to request the erasure of personal data stored by VitaDAO, he
            or she may, at any time, contact any employee of the controller. An
            employee of VitaDAO shall promptly ensure that the erasure request
          ...
          <p>
            ...
            as processing is not required. An employees of VitaDAO will arrange
        ...
        <li>
          ...
          <p>
            ...
            stored by VitaDAO, he or she may at any time contact any employee of
            the controller. The employee of VitaDAO will arrange the restriction
            of the processing.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            ...
            data concerning him or her by VitaDAO for scientific or historical
        ...
        <li>
          ...
          <p>
            ...
            consent, VitaDAO shall implement suitable measures to safeguard the
      ...
      <p>
        ...
        which users may publish and spread so-called &apos;tweets&apos;, e.g.
        short messages, which are limited to 280 characters. These short
        messages are available for everyone, including those who are not logged
        on to Twitter. The tweets are also displayed to so-called followers of
        the respective user. Followers are other Twitter users who follow a
        user&apos;s tweets. Furthermore, Twitter allows you to address a wide
